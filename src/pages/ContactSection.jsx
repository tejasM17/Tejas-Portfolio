...
export const ContactSection = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      label: "Leetcode",
      link: "https://leetcode.com/u/tejasM17/",
      customColor: "#FFA116", // LeetCode brand color
    },
    {
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <textarea
                ...
                className="w-full p-3 h-36 rounded-md bg-[#181818] border border-white/10 text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 transition resize-none"
              ></textarea>
              <button
                type="submit"
                  ...
                  >
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-tr from-[#1f1f1f] via-[#2d2d2d] to-[#3b3b3b] border border-white/10 group-hover:shadow-[0_0_20px_var(--tw-shadow-color)] shadow-cyan-500/30">
                      <Icon
                        ...
                        width={28}
                        height={28}
                        style={social.customColor ? { color: social.customColor } : {}}
                      />
                    </div>
